...
export default function CbDemoFps_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $CbDemoFps_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $CbDemoFps_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $CbDemoFps_Text_Service
    }
}
