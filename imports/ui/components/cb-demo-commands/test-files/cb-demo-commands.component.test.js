...
import Component from "./../cb-demo-commands.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {CbDemoCommands_Styles_Service} from "./../services/cb-demo-commands.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (cb-demo-commands.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("cb-demo-commands-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("cb-demo-commands-" + key)
